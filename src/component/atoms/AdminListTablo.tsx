...
function AdminListTablo({ admins }: { admins: IAdminList[] }) {
    ...
    return (
        <>
                    ...
                    {admins.map((admin) => (
                        <tr key={admin.id}>
                            <td style={{whiteSpace: 'nowrap'}}><img src={admin.avatar} style={{width:'75px',height:'75px',borderRadius:'20px'}} /></td>
                            <td style={{whiteSpace: 'nowrap'}}>{admin.name}</td>
                            <td style={{whiteSpace: 'nowrap'}}>{admin.surname}</td>
                            <td style={{whiteSpace: 'nowrap'}}>{admin.email}</td>
                            <td style={{whiteSpace: 'nowrap'}}>{admin.address}</td>
                            <td style={{whiteSpace: 'nowrap'}}>{admin.phone}</td>
