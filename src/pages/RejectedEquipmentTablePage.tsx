...
import RejectedEquipmentTable from '../component/molecules/RejectedEquipmentTable';

function RejectedEquipmentTablePage() {
                    ...
                    <div className="col-9">
                        ...
                        <div className="row">
                            <table className="table table-dark table-striped mt-5">
                                <thead>
                                    <tr>
                                        <th colSpan={7} className="table-active  "><h1 className='text-center' >Reddedilen Zimmet Listesi</h1></th>
                                    </tr>
...
export default RejectedEquipmentTablePage